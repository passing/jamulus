...
CMultiColorLED::CMultiColorLED ( QWidget* parent ) :
    QLabel ( parent ),
    BitmCubeDisabled (
        QString::fromUtf8 ( ":/png/LEDs/res/CLEDDisabledSmall.png" ) ),
    ...
    BitmCubeYellow (
        QString::fromUtf8 ( ":/png/LEDs/res/CLEDYellowSmall.png" ) ),
    BitmCubeRed ( QString::fromUtf8 ( ":/png/LEDs/res/CLEDRedSmall.png" ) ),
    BitmIndicatorGreen (
        QString::fromUtf8 ( ":/png/LEDs/res/IndicatorGreen.png" ) ),
    BitmIndicatorYellow (
        QString::fromUtf8 ( ":/png/LEDs/res/IndicatorYellow.png" ) ),
