...
void CJamController::SetEnableRecording ( bool bNewEnableRecording,
                                          bool isRunning )
{
                                       ...
                                       bool    bDisableRecording )
{
    ...
    if ( bRecorderInitialised )
    {
        ...
        // QT signals
        QObject::connect ( pthJamRecorder,
                           &QThread::finished,
                           pJamRecorder,
                           &QObject::deleteLater );
        ...
        QObject::connect ( this,
                           &CJamController::RestartRecorder,
                           pJamRecorder,
                           &CJamRecorder::OnTriggerSession );

        QObject::connect ( this,
                           &CJamController::StopRecorder,
                           pJamRecorder,
                           &CJamRecorder::OnEnd );
