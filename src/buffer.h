...
class CNetBuf
{
  ...
  protected:
    ...
    static constexpr int iNumBytesSeqNum =
        1; // per definition 1 byte sequence counter
};
...
class CNetBufWithStats : public CNetBuf
{
  public:
    ...
    void SetUseDoubleSystemFrameSize ( const bool bNDSFSize )
    {
        bUseDoubleSystemFrameSize = bNDSFSize;
    }
